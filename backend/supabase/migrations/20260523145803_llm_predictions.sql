...
comment on column llm_config.model is 'Provider-specific model identifier (e.g. ''gpt-5-nano-2025-08-07'', ''claude-sonnet-4-6'').';
...
comment on column llm_prediction.model_snapshot is 'Resolved provider-specific model snapshot/version that actually answered (e.g. ''gpt-5-nano-2025-08-07''); may differ from llm_config.model when an alias was used.';
...
comment on column llm_prediction.error is 'Error message if the call failed; null on success.';
