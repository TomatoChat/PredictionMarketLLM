...
# interpolation syntax. URL-escaped credentials and query values legitimately
# contain percent signs, so escape them for ConfigParser before it parses the
# option back into the SQLAlchemy URL.
